...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function r=dbFnEvaluateMatchingLocalTextonsColor(outputBasePath, annotation, varargin) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
overlapTextonW = nnz(weights(bgMask(:)) > 0.6) / nnz(bgMask) > 0.05;

fprintf('Computing the joint...');
histObjJoint = myHistoND(imgVec(objMask(:),:), nbBins, mins, maxs);
histBgDstJoint = myHistoNDWeighted(imgVec(bgMask(:),:), weights(bgMask(:)), nbBins, mins, maxs);

%% Try all local measures
% Obj and BgDst
imgInfo = setFieldDist(imgInfo, type, 'objBgDstTextonColorW', 'joint', 1, histObjJoint, histBgDstJoint, overlapTextonW, nbBins);
...
for c=1:3
    ...
    % Obj and BgDst
    imgInfo = setFieldDist(imgInfo, type, 'objBgDstTextonColorW', 'marginal', c, histObj, histBgDst, overlapTextonW, nbBins);
end
fprintf('done!\n');
