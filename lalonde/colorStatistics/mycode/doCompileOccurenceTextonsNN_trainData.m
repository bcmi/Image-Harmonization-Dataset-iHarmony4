...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function doCompileOccurenceTextonsNNglobal histoImg histoBg histoObj indObj indImg nbImg nbObjects nbImgGlob indImgGlob;
...
nbObjects = 0; nbImg = 0; nbImgGlob = 0;
...
fprintf('Total number of images found: %d\n', nbImgGlob);
...
indImgGlob = zeros(nbObjects, 1); 

nbImg = 0; nbObjects = 0; nbImgGlob = 0;
...
save(fullfile(outputDbPath, sprintf('trainDataTextons_%dx%d.mat', N, N)), 'histoImg', 'histoBg', 'histoObj', 'indObj', 'indImg', 'indImgGlob');

function dbFnCount(annotation, dbPath, outputBasePath, varargin)
global nbObjects nbImg nbImgGlob;

nbImgGlob = nbImgGlob + 1;
...
global histoImg histoBg histoObj indObj indImg nbImg nbObjects indImgGlob nbImgGlob;
...
if isfield(annotation, 'colorStatisticsTextons5x5ObjBgUnsorted')
    if (isfield(annotation.colorStatisticsTextons5x5ObjBgUnsorted, 'file'))
        ...
        indImgGlob(nbObjects+1:nbObjects+nbObjCur, :) = repmat(nbImgGlob, size(textonHistObj, 1), 1);
