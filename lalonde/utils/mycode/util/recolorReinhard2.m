...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [outPixels, meanDiff, stdRatio] = recolorReinhard2(srcPixels, tgtPixels, srcPixelsToRecolor, doLab, alphaMean, alphaVar)
...
if doLab
    ...
    [L,a,b] = rgb2lab(srcPixelsToRecolor(:,1), srcPixelsToRecolor(:,2), srcPixelsToRecolor(:,3)); srcPixelsToRecolor = [L(:) a(:) b(:)];
end
...
nbSrcPixelsToRecolor = size(srcPixelsToRecolor, 1);
outPixels = (srcPixelsToRecolor - repmat(srcMean, [nbSrcPixelsToRecolor 1])) .* alphaVar.*repmat(stdRatio, [nbSrcPixelsToRecolor 1]) + repmat(srcMean, [nbSrcPixelsToRecolor 1]);

% move towards mean (but not completely)
outPixels = outPixels + alphaMean.*repmat(meanDiff, [nbSrcPixelsToRecolor 1]);
