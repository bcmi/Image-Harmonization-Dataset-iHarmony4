%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function doSplitDatasetImagesReal
%  Randomly select half of the real images for training
% 
% Input parameters:
%        
% Output parameters:
...
inputBasePath = fullfile(basePath, 'filteredDb');
inputBasePathPopup = fullfile(basePath, 'filteredDbPopup');

outputBasePath = fullfile(basePath, 'filteredTrainingRealDb');
outputBasePathPopup = fullfile(basePath, 'filteredTrainingRealDbPopup');
