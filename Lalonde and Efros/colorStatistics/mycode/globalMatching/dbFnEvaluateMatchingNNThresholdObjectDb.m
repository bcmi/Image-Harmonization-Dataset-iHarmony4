%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function dbFnEvaluateMatchingNNThresholdObjectDb(outputBasePath, annotation, varargin)
%   
% 
% Input parameters:
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function r=dbFnEvaluateMatchingNNThresholdObjectDb(outputBasePath, annotation, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
objImgInd = getDatabaseIndexFromFilename(args.ObjectDb, 'document', annotation.image.folder, annotation.image.filename);
bgImgInd = getDatabaseIndexFromFilename(args.ObjectDb, 'document', annotation.image.folder, annotation.image.filename);
fprintf('done.');
