%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function processLabelmeDatabaseFast(basePath, includeStrings, excludeStrings, outputBasePath, dbFn, parallelized, randomized, varargin)
...
processDatabaseFast(basePath, includeStrings, excludeStrings, outputBasePath, dbFn, parallelized, randomized, ...
    'annotation', varargin{:});
